...
def save_into_file(dataset_finished):
    # TODO: Sava data to the file
    pass


def MCTS_self_play(board: np.ndarray = initialize_game_state(), player: BoardPiece = PLAYER1):
    # Init variables
    ...
    save_into_file(dataset_finished)
