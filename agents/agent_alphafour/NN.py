...
from naf.alphafour.agents.agent_alphafour.neural import createNeuralBoard
from naf.alphafour.agents.common import string_to_board
from naf.alphafour.agents.helpers import PLAYER1
...
class Convblock(nn.Module):
    def __init__(self):
        ...
        self.conv = nn.Conv2d(1, 42, (3, 3), stride=(1, 1), padding=1)
...
class AlphaNet(torch.nn.Module):
    ...
    def __init__(self) -> None:
        ...
        self.resLayers = [ResBlock(6,7)] * 19
