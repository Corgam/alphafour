...
class Node_MCTS:
    ...
    def __init__(self, state: Connect4State_MCTS = None, parent_move: PlayerAction = None, parent: Node_MCTS = None):
        ...
        self.children: List[Node_MCTS] = []  # Set of all possible children
    ...
    def add_child(self, move: PlayerAction, state: Connect4State_MCTS) -> Node_MCTS:
        """
        ...
        """
        child = Node_MCTS(state, move, self)
        self.untried_moves.remove(move)
        self.children.append(child)
        return child

    def select_best_child(self) -> Node_MCTS:
        """
...
def expand_MCTS(node: Node_MCTS, state: Connect4State_MCTS):
    """
...
def rollout_MCTS(state: Connect4State_MCTS):
    """
...
def backpropagate_MCTS(node: Node_MCTS, state: Connect4State_MCTS):
    """
...
def run_basic_MCTS(root_state: Connect4State_MCTS, simulation_no=100) -> (PlayerAction, Node_MCTS):
    """
    ...
    :return: best_move
    """
    root_node = Node_MCTS(root_state)
